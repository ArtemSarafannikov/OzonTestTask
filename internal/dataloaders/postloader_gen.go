...
func (l *PostLoader) Load(key string) (*models.Post, error) {
...
func (l *PostLoader) LoadThunk(key string) func() (*models.Post, error) {
	l.mu.Lock()
...
func (l *PostLoader) LoadAll(keys []string) ([]*models.Post, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *PostLoader) LoadAllThunk(keys []string) func() ([]*models.Post, []error) {
	results := make([]func() (*models.Post, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *PostLoader) Prime(key string, value *models.Post) bool {
	l.mu.Lock()
	var found bool
...
func (l *PostLoader) unsafeSet(key string, value *models.Post) {
	if l.cache == nil {
		l.cache = map[string]*models.Post{}
	}
	l.cache[key] = value
}
